# -*- coding: utf-8 -*-
"""
Created on Fri Mar 20 19:03:46 2020
...
data_path = 'E:\\BE-PROJECT\\crime16'
...
os.makedirs('E:\\BE-PROJECT\\weights_crime',exist_ok = True)
...
for epoch in range(num_epochs):
    ...
    for phase in phase1:
        ...
        torch.save(model.state_dict(),'E:\\BE-PROJECT\\weights_crime\\c3d_{}.h5'.format(epoch))
        if(phase=='train'):
